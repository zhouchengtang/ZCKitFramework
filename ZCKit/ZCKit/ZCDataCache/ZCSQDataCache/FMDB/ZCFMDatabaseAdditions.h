...
/** Category of additions for `<ZCFMDatabase>` class.
...
@interface ZCFMDatabase (ZCFMDatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `ZCFMResultSet` of schema; `nil` on error.
