...
/** Represents the results of executing a query on an `<ZCFMDatabase>`.
...
@interface ZCFMResultSet : NSObject {
    ZCFMDatabase          *_parentDB;
    ZCFMStatement         *_statement;
...
/** `ZCFMStatement` used by result set. */

@property (atomic, retain) ZCFMStatement *statement;

///------------------------------------
/// @name Creating and closing database
///------------------------------------

/** Create result set from `<ZCFMStatement>`

 @param statement A `<ZCFMStatement>` to be performed

 @param aDB A `<ZCFMDatabase>` to be used

 @return A `ZCFMResultSet` on success; `nil` on failure
 */

+ (instancetype)resultSetWithStatement:(ZCFMStatement *)statement usingParentDatabase:(ZCFMDatabase*)aDB;

/** Close result set */

- (void)close;

- (void)setParentDB:(ZCFMDatabase *)newDb;
