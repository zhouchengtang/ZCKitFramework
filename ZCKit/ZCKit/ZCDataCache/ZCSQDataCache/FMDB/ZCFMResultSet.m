...
+ (instancetype)resultSetWithStatement:(ZCFMStatement *)statement usingParentDatabase:(ZCFMDatabase*)aDB {
    ...
    return ZCFMDBReturnAutoreleased(rs);
}
...
- (void)dealloc {
    ...
    ZCFMDBRelease(_columnNameToIndexMap);
...
- (NSDictionary*)resultDict {
    ...
    if (num_cols > 0) {
        ...
        return ZCFMDBReturnAutoreleased([dict copy]);
    }
    else {
