...
@implementation UIDevice(ZCHardware)
...
-(NSString * ) zcUniqueIdentifier{
    ...
    if(uniqueIdentifier == nil){
        ...
        CFTypeRef inTypeRef = (__bridge CFTypeRef)data;
        ...
        if([data length] == 32){
            ...
            if([self respondsToSelector:@selector(identifierForVendor)]){
                uniqueIdentifier = [[[self identifierForVendor] UUIDString] zcMD5String];
            }
            ...
            if(uniqueIdentifier == nil){
                ...
                uniqueIdentifier = [[NSData dataWithBytes:suuid length:sizeof(suuid)] zcMD5String];
            }
