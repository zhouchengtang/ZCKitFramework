...
/**
 * Integrates ZC_SDWebImage async downloading and caching of remote images with UIImageView.
 *
 * Usage with a UITableViewCell sub-class:
 *
 * @code

#import <ZC_SDWebImage/UIImageView+ZCSD_WebCache.h>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Here we use the provided zc_sd_setImageWithURL: method to load the web image
    // Ensure you use a placeholder image otherwise cells will be initialized with no image
    [cell.imageView zc_sd_setImageWithURL:[NSURL URLWithString:@"http://example.com/image.jpg"]
 ...
 * @endcode
 */
@interface UIImageView (ZCSD_WebCache)
