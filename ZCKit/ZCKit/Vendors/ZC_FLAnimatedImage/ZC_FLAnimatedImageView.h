...
@class ZC_FLAnimatedImage;
@protocol ZC_FLAnimatedImageViewDebugDelegate;


//
//  An `ZC_FLAnimatedImageView` can take an `ZC_FLAnimatedImage` and plays it automatically when in view hierarchy and stops when removed.
...
//
@interface ZC_FLAnimatedImageView : UIImageView
...
@property (nonatomic, strong) ZC_FLAnimatedImage *animatedImage;
